...
const products = [
  {
    title: "Argentina 1st Kit t-shirt 2024",
    discount: 15,
    stars: 4.9,
    price: 49.99,
    comments: 455,
    image:
      "https://marcadegol.com/fotos//2024/03/review-camiseta-titular-adidas-de-argentina-2024-2025-1-1.jpg",
  },
  {
    title: "Argentina 2nd Kit t-shirt 2024",
    discount: 10,
    stars: 4.8,
    price: 59.99,
    comments: 255,
    image:
      "https://www.dexter.com.ar/on/demandware.static/-/Sites-365-dabra-catalog/default/dwb2f3e395/products/ADIP8403/ADIP8403-3.JPG",
  },
  {
    title: "Argentina 1st Kit t-shirt 2024",
    discount: 15,
    ...
    <>
      ...
      <section className="py-8 antialiased md:py-12">
        ...
        <form
          ...
          tabIndex={-1}
          aria-hidden="true"
          className="h-modal fixed left-0 right-0 top-0 z-50 hidden w-full overflow-y-auto overflow-x-hidden p-4 md:inset-0 md:h-full"
        >
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="col-span-2 flex items-center justify-between space-x-2">
                        <input
                          ...
                          min="0"
                          max="7000"
                          className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-foreground focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700  dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500 "
                          placeholder=""
                          required
                        />
