          ...
          >
            ...
            <div>
              ...
              <input
                ...
                value={username}
                id="username"
                className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-900 focus:border-blue-500 focus:border-primary-600 focus:ring-blue-500 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 sm:text-sm"
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-red-600 px-5 py-2.5 text-center text-sm font-medium text-gray-200 hover:bg-primary-700 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
            >
              Registrate
            </button>
